	...
	public class ClaimCrud {
		...
		public static List<Claim> TableToList(DataTable table){
			...
			for(int i=0;i<table.Rows.Count;i++) {
				...
				claim.PlaceService                = (OpenDentBusiness.PlaceOfService)PIn.Int(table.Rows[i]["PlaceService"].ToString());
				...
				claim.EmployRelated               = (OpenDentBusiness.YN)PIn.Int(table.Rows[i]["EmployRelated"].ToString());
				...
				claim.PatRelat                    = (OpenDentBusiness.Relat)PIn.Int(table.Rows[i]["PatRelat"].ToString());
				claim.PlanNum2                    = PIn.Long  (table.Rows[i]["PlanNum2"].ToString());
				claim.PatRelat2                   = (OpenDentBusiness.Relat)PIn.Int(table.Rows[i]["PatRelat2"].ToString());
				...
				claim.SpecialProgramCode          = (OpenDentBusiness.EnumClaimSpecialProgram)PIn.Int(table.Rows[i]["SpecialProgramCode"].ToString());
				claim.UniformBillType             = PIn.String(table.Rows[i]["UniformBillType"].ToString());
				claim.MedType                     = (OpenDentBusiness.EnumClaimMedType)PIn.Int(table.Rows[i]["MedType"].ToString());
				...
				claim.CorrectionType              = (OpenDentBusiness.ClaimCorrectionType)PIn.Int(table.Rows[i]["CorrectionType"].ToString());
				...
				claim.OrthoTotalM                 = PIn.Byte  (table.Rows[i]["OrthoTotalM"].ToString());
				retVal.Add(claim);
			}
			return retVal;
		}
