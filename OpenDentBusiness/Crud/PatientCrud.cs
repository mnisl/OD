	...
	public class PatientCrud {
		...
		public static List<Patient> TableToList(DataTable table){
			...
			for(int i=0;i<table.Rows.Count;i++) {
				...
				patient.PatStatus                = (OpenDentBusiness.PatientStatus)PIn.Int(table.Rows[i]["PatStatus"].ToString());
				patient.Gender                   = (OpenDentBusiness.PatientGender)PIn.Int(table.Rows[i]["Gender"].ToString());
				patient.Position                 = (OpenDentBusiness.PatientPosition)PIn.Int(table.Rows[i]["Position"].ToString());
				...
				patient.GradeLevel               = (OpenDentBusiness.PatientGrade)PIn.Int(table.Rows[i]["GradeLevel"].ToString());
				patient.Urgency                  = (OpenDentBusiness.TreatmentUrgency)PIn.Int(table.Rows[i]["Urgency"].ToString());
				...
				patient.PreferConfirmMethod      = (OpenDentBusiness.ContactMethod)PIn.Int(table.Rows[i]["PreferConfirmMethod"].ToString());
				patient.PreferContactMethod      = (OpenDentBusiness.ContactMethod)PIn.Int(table.Rows[i]["PreferContactMethod"].ToString());
				patient.PreferRecallMethod       = (OpenDentBusiness.ContactMethod)PIn.Int(table.Rows[i]["PreferRecallMethod"].ToString());
				...
				patient.PreferContactConfidential= (OpenDentBusiness.ContactMethod)PIn.Int(table.Rows[i]["PreferContactConfidential"].ToString());
				patient.SuperFamily              = PIn.Long  (table.Rows[i]["SuperFamily"].ToString());
				patient.TxtMsgOk                 = (OpenDentBusiness.YN)PIn.Int(table.Rows[i]["TxtMsgOk"].ToString());
