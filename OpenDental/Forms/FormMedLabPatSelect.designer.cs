namespace OpenDental {
	partial class FormMedLabPatSelect {
		...
		private void InitializeComponent() {
			...
			this.gridPidInfo.ScrollValue = 0;
			...
			this.gridPidInfo.TranslationName = null;
			// 
			// FormMedLabPatSelect
			// 
		...
		private OpenDental.UI.ODGrid gridLabs;
