...
namespace UnitTests {
	...
	public class HL7Tests {
		...
		public static string HL7TestAll(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			retval+=Test2(hl7TestInterfaceEnum);
			retval+=Test3(hl7TestInterfaceEnum);
			retval+=Test4(hl7TestInterfaceEnum);
			retval+=Test5(hl7TestInterfaceEnum);
			retval+=Test6(hl7TestInterfaceEnum);
			retval+=Test7(hl7TestInterfaceEnum);
			retval+=Test8(hl7TestInterfaceEnum);
			retval+=Test9(hl7TestInterfaceEnum);
			retval+=Test10(hl7TestInterfaceEnum);
			retval+=Test11(hl7TestInterfaceEnum);
		...
		public static string Test2(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(pat==null) {
				return "Test 2: Couldn't locate patient.\r\n";
			}
			if(guar==null) {
				return "Test 2: Couldn't locate guarantor.\r\n";
			}
			//Set up the rest of pat information
			correctPat.PriProv=PrefC.GetLong(PrefName.PracticeDefaultProv);
			correctPat.BillingType=PrefC.GetLong(PrefName.PracticeDefaultBillType);
		...
		public static string Test3(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(correctGuar==null) {
				return "Test 3: Couldn't locate guarantor.\r\n";
			}
			MessageHL7 msg=new MessageHL7(msgtext);
			try {
				switch(hl7TestInterfaceEnum) {
		...
		public static string Test6(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(pat==null) {
				return "Test 6: Couldn't locate patient.\r\n";
			}
			//Set up the rest of pat information
			correctPat.PriProv=PrefC.GetLong(PrefName.PracticeDefaultProv);
			correctPat.BillingType=PrefC.GetLong(PrefName.PracticeDefaultBillType);
			...
			Appointment apt=Appointments.GetOneApt(100);
			if(apt==null) {
				return "Test 6: Couldn't locate appointment.\r\n";
			}
			string retval="";
			if(apt.PatNum!=pat.PatNum) {
				retval+="Appointment.PatNum does not match patient.PatNum.\r\n";
			...
			retval+=CompareGuarAndPat(pat,correctPat,guar,correctGuar,hl7TestInterfaceEnum);
			if(retval.Length>0) {
				return "Test 6: "+retval;
			}
			return "Test 6: Passed.\r\n";
		}
		...
		public static string Test7(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(correctPat==null) {
				return "Test 7: Couldn't locate patient.\r\n";
			}
			Appointment apt=Appointments.GetOneApt(100);
			if(apt==null) {
				return "Test 7: Couldn't locate appointment.\r\n";
			}
			Appointment correctApt=apt.Clone();
			apt.PatNum=40;
		...
		public static string Test8(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(correctPat==null) {
				return "Test 8: Couldn't locate patient.\r\n";
			}
			if(correctGuar==null) {
				return "Test 8: Couldn't locate guarantor.\r\n";
			}
			Appointment apt=Appointments.GetOneApt(100);
			if(apt==null) {
				return "Test 8: Couldn't locate appointment.\r\n";
			}
			MessageHL7 msg=new MessageHL7(msgtext);
			try {
				switch(hl7TestInterfaceEnum) {
				...
				if(ex.ToString().Substring(18,68)!="Appointment not processed due to missing patient first or last name.") {
					return "Test 8: Message processing error: "+ex+"\r\n";
				}
			}
			Patient pat=null;
			Patient guar=null;
			...
			string retval=CompareGuarAndPat(pat,correctPat,guar,correctGuar,hl7TestInterfaceEnum);
			if(apt.Note!="Checkup and Fillings") {
				retval+="Appointment.Note is not correct.\r\n";
			}
			if(retval.Length>0) {
				return "Test 8: "+retval;
			}
			return "Test 8: Passed.\r\n";
		}
		...
		public static string Test9(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			pat=Patients.GetPat(30);
			if(pat==null) {
				return "Test 9: Couldn't locate patient.\r\n";
			}
			Provider prov=Providers.GetProvByEcwID("DOC1");
			if(prov==null) {
				return "Test 9: Couldn't locate provider.\r\n";
			}
			Appointment apt=Appointments.GetOneApt(100);
			if(apt==null) {
		...
		public static string Test10(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			pat=Patients.GetPat(30);
			if(pat==null) {
				return "Test 10: Couldn't locate patient.\r\n";
			}
			Provider prov=Providers.GetProvByEcwID("DOC2");
			if(prov==null) {
				return "Test 10: Couldn't locate provider.\r\n";
			}
			Appointment apt=Appointments.GetOneApt(100);
			if(apt==null) {
				return "Test 10: Couldn't locate appointment.\r\n";
			}
		...
		public static string Test13(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			Provider prov=Providers.GetProvByEcwID("DOC1");
			if(prov==null) {
				return "Test 13: Couldn't locate provider.\r\n";
			}
			Appointment apt=new Appointment();
			apt.AptNum=600;
			apt.AptDateTime=new DateTime(2012,09,06,10,0,0);
			...
			proc.PatNum=10;
			proc.ProcDate=new DateTime(2012,09,06);
			proc.CodeNum=ProcedureCodes.GetCodeNum("D2332A");
			proc.ProcStatus=ProcStat.C;
			...
			proc.PatNum=10;
			proc.ProcDate=new DateTime(2012,09,06);
			proc.CodeNum=ProcedureCodes.GetCodeNum("2332AA");
			proc.ProcStatus=ProcStat.C;
			proc.ProvNum=prov.ProvNum;
			proc.ProcFee=250.00;
			proc.ToothNum="2";
			...
			Patient pat=Patients.GetPat(10);
			if(pat==null) {
				return "Test 13: Couldn't locate patient.\r\n";
			}
			Patient guar=Patients.GetPat(11);
			if(guar==null) {
				return "Test 13: Couldn't locate guarantor.\r\n";
			}
			MessageHL7 msg=null;
			try {
				switch(hl7TestInterfaceEnum) {
			...
			string retval=CompareMsgs(msg,correctMsg);
			if(retval.Length>0) {
				return "Test 13: "+retval;
			}
			return "Test 13: Passed.\r\n";
		}

		///<summary>Test 14: Create a treatment plan DFT message with an embedded PDF.  SendHL7 with appointment.AptNum=600, patient.PatNum=10, patient.PriProv=provider.ProvNum for DOC1, pdfDescription=treatment, and the PDF data converted to Base-64 string (for testing purposes this string will just be "Test Message").  No FT1 segments in a PDF DFT message.</summary>
		public static string Test14(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			//  return "Test 14: No DFT messages created in EcwStandalone integration.\r\n";
			//}
			//Patient pat=Patients.GetPat(10);
			//if(pat==null) {
			//  return "Test 14: Couldn't locate patient.\r\n";
			//}
			//Patient guar=Patients.GetPat(11);
			//if(guar==null) {
			//  return "Test 14: Couldn't locate guarantor.\r\n";
			//}
			//List<Procedure> procList=new List<Procedure>();//leave proclist empty since just a PDF message
			//Appointment apt=Appointments.GetOneApt(600);
			//if(apt==null) {
			//  return "Test 14: Couldn't locate appointment.\r\n";
			//}
			//Provider prov=Providers.GetProvByEcwID("DOC1");
			//if(prov==null) {
			//  return "Test 14: Couldn't locate provider.\r\n";
			//}
			//if(hl7TestInterfaceEnum==HL7TestInterfaceEnum.EcwOldStandalone || hl7TestInterfaceEnum==HL7TestInterfaceEnum.HL7DefEcwStandalone) {
			//  return "Test 14: No DFT messages created in EcwStandalone integration.\r\n";
			//}
			...
			//  switch(hl7TestInterfaceEnum) {
			//    case HL7TestInterfaceEnum.EcwOldFull:
			//      return "Test 14: No DFT tests for EcwOldFull.\r\n";
			//    case HL7TestInterfaceEnum.EcwOldTight:
			//      OpenDentBusiness.HL7.EcwDFT dft=new OpenDentBusiness.HL7.EcwDFT();
			//      dft.InitializeEcw(apt.AptNum,prov.ProvNum,pat,"Test Message","treatment",true);
			//      msg=new MessageHL7(dft.GenerateMessage());
			//      break;
			//    case HL7TestInterfaceEnum.HL7DefEcwFull:
			//      return "Test 14: No DFT tests for HL7DefEcwFull.\r\n";
			//    default:
			...
			//}
			//catch(Exception ex) {
			//  return "Test 14: Message creation error. "+ex+".\r\n";
			//}
		...
		public static string CompareGuarAndPat(Patient pat,Patient correctPat,Patient guar,Patient correctGuar,HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string retval="";
		...
		public static string CompareMsgs(MessageHL7 msg,MessageHL7 correctMsg) {
			string retval="";
			for(int s=0;s<msg.Segments.Count;s++) {
				for(int f=0;f<msg.Segments[s].Fields.Count;f++) {
					if(msg.Segments[s].Fields[f].ToString()!=correctMsg.Segments[s].Fields[f].ToString()) {
						retval+="Correct message segment "+correctMsg.Segments[s].Name.ToString()+" field "+f+": "+correctMsg.Segments[s].Fields[f].ToString()+".  "
							+"Message segment "+msg.Segments[s].Name.ToString()+" field "+f+": "+msg.Segments[s].Fields[f].ToString()+".\r\n";
					}
				}
			}
			return retval;
